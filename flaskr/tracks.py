...
def names():
    ...
    return render_template('names.html', names=unique_names, count_of_unique_names=count)
...
def tracks_genre(genre=None):
    ...
    return render_template('tracks_genre.html', titles=tracks, count_of_tracks=count, genre=genre)
...
def tracks_sec():
    ...
    return render_template('tracks_len.html', track_plus_length=tracks_and_sec)
...
def tracks_sec_statistics():
    ...
    return render_template('tracks_statistics.html', value=average_and_sum_value)
